---
title: Kmeans with simulated data
---
...
<table>
  <tr style="vertical-align: top;">
    ...
    <td>
      ...
      <p>points = randomly choose cluster for each point, then calculate centroids</p>
      <p>centroids = randomly choose k points to be centroids, then reassign points</p>
      <div style="height: 15px;"></div>
      <div id="buttons"></div>
    </td>
  </tr>  
